...
import { XionAdventuresHubQueryMsgBuilder, XionAdventuresHubExecuteMsgBuilder } from "./XionAdventuresHub.message-builder";
export interface IXionAdventuresHubAppQueryClient {
  moduleId: string;
...
export class XionAdventuresHubAppQueryClient implements IXionAdventuresHubAppQueryClient {
  accountPublicClient: AccountPublicClient;
  moduleId: string;
  _moduleAddress: string | undefined;
  ...
  config = async (): Promise<ConfigResponse> => {
    return this._query(XionAdventuresHubQueryMsgBuilder.config());
  };
  nextTokenId = async (): Promise<NextTokenIdResponse> => {
    return this._query(XionAdventuresHubQueryMsgBuilder.nextTokenId());
  };
...
export interface IXionAdventuresHubAppClient extends IXionAdventuresHubAppQueryClient {
...
export class XionAdventuresHubAppClient extends XionAdventuresHubAppQueryClient implements IXionAdventuresHubAppClient {
  accountWalletClient: AccountWalletClient;
  ...
  ibcTransfer = async (params: CamelCasedProperties<Extract<ExecuteMsg, {
    ...
    return this._execute(XionAdventuresHubExecuteMsgBuilder.ibcTransfer(params), fee_, memo_, funds_);
  };
  mint = async (params: CamelCasedProperties<Extract<ExecuteMsg, {
    ...
    return this._execute(XionAdventuresHubExecuteMsgBuilder.mint(params), fee_, memo_, funds_);
  };
  modifyMetadata = async (params: CamelCasedProperties<Extract<ExecuteMsg, {
    ...
    return this._execute(XionAdventuresHubExecuteMsgBuilder.modifyMetadata(params), fee_, memo_, funds_);
  };
